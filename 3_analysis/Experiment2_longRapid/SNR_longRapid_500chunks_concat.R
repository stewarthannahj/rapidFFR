...
for (h in 1:21){
  ...
  for(i in 1:6){
    ...
    for(z in 1:length(chunks)){
      ...
      dataName_add <- paste("out/Experiment2_longRapid/Routput_longRapid_500chunks/snr_",listener,"_longRapid_",chunk,"_",var_name[i],"add_28July21.csv")
      dataName_sub <- paste("out/Experiment2_longRapid/Routput_longRapid_500chunks/snr_",listener,"_longRapid_",chunk,"_",var_name[i],"sub_28July21.csv")
...
# save to data file      
write.csv(lineData.add,file=paste("out/Experiment2_longRapid/snr_longRapid_500chunks_concat_add.csv"))
write.csv(lineData.sub,file=paste("out/Experiment2_longRapid/snr_longRapid_500chunks_concat_sub.csv"))
