...
signalfile1<-read.csv("in/Experiment2_longRapid/rep1000_longRapid_first18000cycles_500chunks_pt1.csv",header=TRUE)
signalfile2<-read.csv("in/Experiment2_longRapid/rep1000_longRapid_first18000cycles_500chunks_pt2.csv",header=TRUE)
signalfile3<-read.csv("in/Experiment2_longRapid/rep1000_longRapid_first18000cycles_500chunks_pt3.csv",header=TRUE)

signalfile <- rbind(signalfile1, signalfile2, signalfile3)
...
for (h in 1:21){
  ...
  for(z in 1:length(allCHUNKS)){
    ...
    for(i in 9:14){
      ...
      write.csv(cor.matrix.add,file=paste("out/Experiment2_longRapid/Routput_longRapid_500chunks/snr_",listener,"_longRapid_",chunky,"_",var_name[i],"add_28July21.csv"))
      write.csv(cor.matrix.sub,file=paste("out/Experiment2_longRapid/Routput_longRapid_500chunks/snr_",listener,"_longRapid_",chunky,"_",var_name[i],"sub_28July21.csv"))
    }
  }
}
