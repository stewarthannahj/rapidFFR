# calculate mean for noise floor, sub rows only (rapid FFR) (rapid FFR)
...
write.csv(zscores,"out/Experiment1_normalVrapid/nzfloor_mean_rapid_sub.csv",row.names=FALSE)
