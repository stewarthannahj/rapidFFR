...
signalfile = read.csv("500_to_7500nReps_std.csv",header=T)
...
for (h in 1:16){
  ...
  for(z in 1:length(ALLnReps_nz)){
    ...
    for(i in 9:14){
      ...
      write.csv(cor.matrix.add,file=paste("C:/Users/t.schoof/Documents/Work/Rapid FFR/7500nReps/R output/dprime_",listener,"_std_",nReps,"_",var_name[i],"add_July21.csv"))
      write.csv(cor.matrix.sub,file=paste("C:/Users/t.schoof/Documents/Work/Rapid FFR/7500nReps/R output/dprime_",listener,"_std_",nReps,"_",var_name[i],"sub_July21.csv"))
    }
  }
}
