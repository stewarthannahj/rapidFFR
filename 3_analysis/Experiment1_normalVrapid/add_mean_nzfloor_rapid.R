# calculate mean for noise floor, add rows only (rapid FFR) (rapid FFR)
...
write.csv(zscores,"out/Experiment1_normalVrapid/nzfloor_mean_rapid_add.csv",row.names=FALSE)
